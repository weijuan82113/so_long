...
/*   Updated: 2022/12/30 15:12:27 by wchen            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_img	*sprite_lstnew(void *mlx, char object, char *size)
{
	...
	if (!img_head)
		exit(EXIT_FAILURE);
	if (object == P1)
		img_head->img_path = ft_strjoin(P1_PATH, size);
	else if (object == P2)
		img_head->img_path = ft_strjoin(P2_PATH, size);
	else if (object == P3)
		img_head->img_path = ft_strjoin(P3_PATH, size);
	img_head->obj = 'P';
